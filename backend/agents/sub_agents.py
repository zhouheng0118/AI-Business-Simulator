...
def _build_system_prompt(
    ...
    if mission_active:
        ...
        prompt += (
            ...
            "STRICT CONSTRAINT: Only cite specific numbers, percentages, headcounts, costs, "
            "and dates that are explicitly listed in your allowed_info above. "
            "Do NOT invent, estimate, or extrapolate any figures. "
            "If a student asks for a figure not in your allowed_info, say you do not have that "
            "specific data and direct them to the appropriate stakeholder.\n\n"
            "[How to respond]\n"
            "1. Answer first. A follow-up question is never a substitute for an answer.\n"
            "2. Include 1-3 concrete facts, numbers, or operational details — "
            "only from your allowed_info.\n"
