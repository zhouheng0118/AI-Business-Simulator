...
export const api = {
    ...
    professor: {
        ...
        updatePlaybookContent: (
            caseId: string,
            playbookId: string,
            body: { roles?: ApiPlaybookRole[]; questions?: ApiQuestion[]; description?: string; teaching_goals?: string[] },
        ) => patch<{ status: string }>(`/cases/${caseId}/playbook/${playbookId}/content`, body),
    },
};
